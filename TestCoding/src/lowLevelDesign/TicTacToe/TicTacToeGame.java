...
import lowLevelDesign.TicTacToe.model.Pair;
import lowLevelDesign.TicTacToe.model.PieceType;
import lowLevelDesign.TicTacToe.model.Player;
import lowLevelDesign.TicTacToe.model.PlayingPieceO;
import lowLevelDesign.TicTacToe.model.PlayingPieceX;
	...
	public String startGame() {
		...
		while (noWinner) {
			...
			if (!pieceAddedSuccessfully) {
				...
				// cell
				System.out.println("Incorrect possition choosen, try again");
